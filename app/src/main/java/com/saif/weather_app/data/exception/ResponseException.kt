package com.saif.weather_app.data.exception

import android.util.Log
import com.saif.weather_app.data.remote.response.ServerErrorResponse
    ...
    fun deserializeServerError() {
        ...
        if (responseBody != null) {
            try {
                ...
                Log.e("error","Server error deserialization $e")
            }
        }
    }
